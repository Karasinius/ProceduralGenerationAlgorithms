// SimpleRNG.cs
// ѕростой детерминированный генератор на базе SplitMix64.
...
public class SimpleRNG
{
    ...
    // »нициализаци€ €вным seed (ulong используетс€ внутри)
    public void Init(ulong seed)
    {
        // SplitMix64 рекомендует добавл€ть фиксированный оффсет
        state = seed + 0x9E3779B97F4A7C15UL;
    }

    // √енераци€ 64-bit значени€ (SplitMix64)
    ...
    // логический с заданной веро€тностью p
